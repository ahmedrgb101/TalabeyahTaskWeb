...
using TalabeyahTaskWeb.Client.Components.Dialogs;
    ...
    where TRequest : new()
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        _canCreate = await CanDoActionAsync(Context.CreateAction, state) && (Context?.ServerContext?.CreateFunc is not null || Context?.ClientContext?.CreateFunc is not null);
