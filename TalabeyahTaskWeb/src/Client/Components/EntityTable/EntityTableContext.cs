...
public abstract class EntityTableContext<TEntity, TId, TRequest>
{
   ...
   /// <summary>
    /// Getting if request is create or update
    /// </summary>
    ...
    public bool IsDisplay =>
       ServerContext?.IsDisplay is true || ClientContext?.IsDisplay is true;
    public bool ColorAll =>
       ServerContext?.ColorAll is true || ClientContext?.ColorAll is true;
