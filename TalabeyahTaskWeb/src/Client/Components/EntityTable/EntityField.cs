...
namespace TalabeyahTaskWeb.Client.Components.EntityTable;
public record EntityField<TEntity>(Func<TEntity, object?> ValueFunc, string DisplayName, string SortLabel = "", Type? Type = null, Func<TEntity, object?> ColorValueFunc=null, RenderFragment<TEntity>? Template = null,bool IsDisplayed = true)
{
    /// <summary>
    ...
    /// A function that returns the actual value of this field from the supplied entity.
    /// </summary>
    public Func<TEntity, object?> ColorValueFunc { get; init; } = ColorValueFunc;
    ...
    /// The type of the field. Default is string, but when boolean, it shows as a checkbox.
    /// </summary>
    public bool IsDisplayed { get; set; } = IsDisplayed;
