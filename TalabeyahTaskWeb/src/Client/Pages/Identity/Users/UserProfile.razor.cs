...
public partial class UserProfile
{
    ...
    //        Password = _password,
    //        Email = _email,
    //        CompaniesIds = _selectedCompaniesValues?.ToList(),
    //        MangementsIds = _selectedManagementsValues?.ToList(),
    //        SectionsIds = _selectedSectionsValues?.ToList(),
    //        PositionId = SelectedPosition,
    //        Code = _code,
    //    };
    //    await ApiHelper.ExecuteCallGuardedAsync(() => UsersClient.UpdateProfileAsync(Id, request), Snackbar);
